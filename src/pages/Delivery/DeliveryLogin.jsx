...
const DeliveryLogin = () => {
  ...
  const { login, setLoading, setError, loading, error } = useDelivery();
      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600">
              New to delivery? {' '}
              <Link to="/delivery/register" className="text-orange-600 hover:text-orange-700 font-medium">
                Join as a Partner
              </Link>
            </p>
          </div>
